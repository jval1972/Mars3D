...
//
//==============================================================================
function SC_GetWeapondefDeclaration(const w: Pweaponinfo_t): string;
...
var
  ret: string;
  plevel: integer;
  wid, aid: integer; // weapon & ammo ids
...
begin
  ...
  wid := pDiff(w, @weaponinfo, SizeOf(weaponinfo_t));
  if IsIntegerInRange(wid, 0, Ord(NUMWEAPONS) - 1) then
