...
const
  ...
  fixedalphSwitchList: array[0..NUMSWITCHLIST] of switchlist_t = (
    // Mars3D switches
    (name1: 'SW1BLUE';  name2: 'SW2BLUE';  episode: 1),
    (name1: 'SW1COMP1'; name2: 'SW2COMP1'; episode: 1),
    (name1: 'SW1KEY';   name2: 'SW2KEY';   episode: 1),
    (name1: 'SW1NORM';  name2: 'SW2NORM';  episode: 1),
    (name1: 'SW1ROCK';  name2: 'SW2ROCK';  episode: 1),
