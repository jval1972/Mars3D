...
begin
  ...
  deh_actions[92].originalname := 'CustomMissile';
  ...
  deh_actions[97].originalname := 'SpawnItem';
  ...
  deh_actions[98].originalname := 'SeekerMissile';
  ...
  deh_actions[114].originalname := 'JumpIfHealthLower';
  ...
  deh_actions[135].originalname := 'RandomMissile';
  ...
  deh_actions[151].originalname := 'SetCustomParam';
  ...
  deh_actions[152].originalname := 'AddCustomParam';
  ...
  deh_actions[153].originalname := 'SubtractCustomParam';
  ...
  deh_actions[154].originalname := 'SetTargetCustomParam';
  ...
  deh_actions[155].originalname := 'AddTargetCustomParam';
  ...
  deh_actions[156].originalname := 'SubtractTargetCustomParam';
  ...
  deh_actions[157].originalname := 'JumpIfCustomParam';
  ...
  deh_actions[158].originalname := 'JumpIfCustomParamLess';
  ...
  deh_actions[159].originalname := 'JumpIfCustomParamGreater';
  ...
  deh_actions[160].originalname := 'JumpIfTargetCustomParam';
  ...
  deh_actions[161].originalname := 'JumpIfTargetCustomParamLess';
  ...
  deh_actions[162].originalname := 'JumpIfTargetCustomParamGreater';
  ...
  deh_actions[169].originalname := 'GoToIfHealthLower';
  ...
  deh_actions[170].originalname := 'GoToIfCustomParam';
  ...
  deh_actions[171].originalname := 'GoToIfCustomParamLess';
  ...
  deh_actions[172].originalname := 'GoToIfCustomParamGreater';
  ...
  deh_actions[173].originalname := 'GoToIfTargetCustomParam';
  ...
  deh_actions[174].originalname := 'GoToIfTargetCustomParamLess';
  ...
  deh_actions[175].originalname := 'GoToIfTargetCustomParamGreater';
  ...
  deh_actions[194].originalname := 'JumpIfMapStringLess';
  ...
  deh_actions[195].originalname := 'JumpIfMapStringGreater';
  ...
  deh_actions[196].originalname := 'JumpIfMapIntegerEqual';
  ...
  deh_actions[197].originalname := 'JumpIfMapIntegerLess';
  ...
  deh_actions[198].originalname := 'JumpIfMapIntegerGreater';
  ...
  deh_actions[199].originalname := 'JumpIfMapFloatEqual';
  ...
  deh_actions[200].originalname := 'JumpIfMapFloatLess';
  ...
  deh_actions[201].originalname := 'JumpIfMapFloatGreater';
  ...
  deh_actions[202].originalname := 'JumpIfWorldStringEqual';
  ...
  deh_actions[203].originalname := 'JumpIfWorldStringLess';
  ...
  deh_actions[204].originalname := 'JumpIfWorldStringGreater';
  ...
  deh_actions[205].originalname := 'JumpIfWorldIntegerEqual';
  ...
  deh_actions[206].originalname := 'JumpIfWorldIntegerLess';
  ...
  deh_actions[207].originalname := 'JumpIfWorldIntegerGreater';
  ...
  deh_actions[208].originalname := 'JumpIfWorldFloatEqual';
  ...
  deh_actions[209].originalname := 'JumpIfWorldFloatLess';
  ...
  deh_actions[210].originalname := 'JumpIfWorldFloatGreater';
  ...
  deh_actions[211].originalname := 'GoToIfMapStringEqual';
  ...
  deh_actions[212].originalname := 'GoToIfMapStringLess';
  ...
  deh_actions[213].originalname := 'GoToIfMapStringGreater';
  ...
  deh_actions[214].originalname := 'GoToIfMapIntegerEqual';
  ...
  deh_actions[215].originalname := 'GoToIfMapIntegerLess';
  ...
  deh_actions[216].originalname := 'GoToIfMapIntegerGreater';
  ...
  deh_actions[217].originalname := 'GoToIfMapFloatEqual';
  ...
  deh_actions[218].originalname := 'GoToIfMapFloatLess';
  ...
  deh_actions[219].originalname := 'GoToIfMapFloatGreater';
  ...
  deh_actions[220].originalname := 'GoToIfWorldStringEqual';
  ...
  deh_actions[221].originalname := 'GoToIfWorldStringLess';
  ...
  deh_actions[222].originalname := 'GoToIfWorldStringGreater';
  ...
  deh_actions[223].originalname := 'GoToIfWorldIntegerEqual';
  ...
  deh_actions[224].originalname := 'GoToIfWorldIntegerLess';
  ...
  deh_actions[225].originalname := 'GoToIfWorldIntegerGreater';
  ...
  deh_actions[226].originalname := 'GoToIfWorldFloatEqual';
  ...
  deh_actions[227].originalname := 'GoToIfWorldFloatLess';
  ...
  deh_actions[228].originalname := 'GoToIfWorldFloatGreater';
  ...
  deh_actions[229].originalname := 'SetMapStr';
  ...
  deh_actions[230].originalname := 'SetWorldStr';
  ...
  deh_actions[247].originalname := 'JumpIf';
  ...
  deh_actions[265].originalname := 'JumpIfTargetInsideMeleeRange';
  ...
  deh_actions[266].originalname := 'JumpIfTracerCloser';
  ...
  deh_actions[272].originalname := 'CheckRange';
  ...
  deh_actions[276].originalname := 'CheckFlag';
  ...
  deh_actions[277].originalname := 'SetAngle';
  ...
  deh_actions[305].originalname := 'CustomComboAttack';
  ...
  deh_actions[306].originalname := 'SetRenderStyle';
  ...
  deh_actions[307].originalname := 'FadeTo';
  ...
  deh_actions[308].originalname := 'SetSize';
  ...
  deh_actions[325].originalname := 'RearrangePointers';
  ...
  deh_actions[326].originalname := 'TransferPointer';
  ...
  deh_actions[327].originalname := 'AlertMonsters';
  ...
  deh_actions[328].originalname := 'LocalEarthQuake';
  ...
  deh_actions[329].originalname := 'Quake';
  ...
  deh_actions[341].originalname := 'OverlayDrawPatchStretched';
  ...
  deh_actions[342].originalname := 'OverlayDrawPixel';
  ...
  deh_actions[343].originalname := 'OverlayDrawRect';
  ...
  deh_actions[344].originalname := 'OverlayDrawLine';
  ...
  deh_actions[345].originalname := 'OverlayDrawText';
  ...
  deh_actions[346].originalname := 'OverlayDrawLeftText';
  ...
  deh_actions[347].originalname := 'OverlayDrawRightText';
  ...
  deh_actions[348].originalname := 'OverlayDrawCenterText';
  ...
  deh_actions[353].action.acp1 := @A_SetPushable;
  deh_actions[353].originalname := strupper('SetPushable');
  {$IFDEF DLL}deh_actions[353].decl := 'A_SetPushable()';{$ENDIF}
  ...
  deh_actions[356].action.acp1 := @A_FireShockGun;
  deh_actions[356].originalname := strupper('FireShockGun');
  {$IFDEF DLL}deh_actions[356].decl := 'A_FireShockGun()';{$ENDIF}
  deh_actions[357].action.acp1 := @A_ShockGunSound;
  deh_actions[357].originalname := strupper('ShockGunSound');
  {$IFDEF DLL}deh_actions[357].decl := 'A_ShockGunSound()';{$ENDIF}
  ...
  deh_actions[360].action.acp1 := @A_FireNerveGun;
  deh_actions[360].originalname := strupper('FireNerveGun');
  {$IFDEF DLL}deh_actions[360].decl := 'A_FireNerveGun()';{$ENDIF}
  deh_actions[361].action.acp1 := @A_FireFreezeGun;
  deh_actions[361].originalname := strupper('FireFreezeGun');
  {$IFDEF DLL}deh_actions[361].decl := 'A_FireFreezeGun()';{$ENDIF}
  deh_actions[362].action.acp1 := @A_FireFlameGun;
  deh_actions[362].originalname := strupper('FireFlameGun');
  {$IFDEF DLL}deh_actions[362].decl := 'A_FireFlameGun()';{$ENDIF}
  deh_actions[363].action.acp1 := @A_LowerWeapon;
  deh_actions[363].originalname := strupper('LowerWeapon');
  {$IFDEF DLL}deh_actions[363].decl := 'A_LowerWeapon()';{$ENDIF}
  ...
  deh_actions[372].action.acp1 := @A_SetSpriteDX;
  deh_actions[372].originalname := 'SetSpriteDX';
  {$IFDEF DLL}deh_actions[372].decl := 'A_SetSpriteDX(dx: float)';{$ENDIF}
  deh_actions[373].action.acp1 := @A_SetSpriteDY;
  deh_actions[373].originalname := 'SetSpriteDY';
  {$IFDEF DLL}deh_actions[373].decl := 'A_SetSpriteDY(dy: float)';{$ENDIF}
  deh_actions[374].action.acp1 := @A_SeeSound1;
  deh_actions[374].originalname := 'SeeSound';
  {$IFDEF DLL}deh_actions[374].decl := 'A_SeeSound()';{$ENDIF}
  deh_actions[375].action.acp1 := @A_PainSound1;
  deh_actions[375].originalname := 'PainSound';
  {$IFDEF DLL}deh_actions[375].decl := 'A_PainSound()';{$ENDIF}
  deh_actions[376].action.acp1 := @A_AttackSound1;
  deh_actions[376].originalname := 'AttackSound';
  {$IFDEF DLL}deh_actions[376].decl := 'A_AttackSound()';{$ENDIF}
  deh_actions[377].action.acp1 := @A_MeleeSound1;
  deh_actions[377].originalname := 'MeleeSound';
  {$IFDEF DLL}deh_actions[377].decl := 'A_MeleeSound()';{$ENDIF}
  deh_actions[378].action.acp1 := @A_DeathSound1;
  deh_actions[378].originalname := 'DeathSound';
  {$IFDEF DLL}deh_actions[378].decl := 'A_DeathSound()';{$ENDIF}
  ...
  deh_actions[380].originalname := 'RestoreReadyWeapon';
