...
begin
  ...
  begin
    ...
    if tmthing.flags4_ex and MF4_EX_SHOCKGUNDAMAGE <> 0 then
    ...
    if tmthing.flags4_ex and MF4_EX_POISONDAMAGE <> 0 then
      if thing.flags4_ex and MF4_EX_NOPOISONDAMAGE <> 0 then
      begin
        result := true;
        exit;
      end;

    if tmthing.flags4_ex and MF4_EX_DISKDAMAGE <> 0 then
...
begin
  ...
  begin
    ...
    if bombsource.flags4_ex and MF4_EX_SHOCKGUNDAMAGE <> 0 then
      if thing.flags4_ex and MF4_EX_NOSHOCKGUNDAMAGE <> 0 then
      begin
        result := true;
        exit;
    ...
    if bombsource.flags4_ex and MF4_EX_POISONDAMAGE <> 0 then
      if thing.flags4_ex and MF4_EX_NOPOISONDAMAGE <> 0 then
      begin
        result := true;
        exit;
    ...
    if bombsource.flags4_ex and MF4_EX_DISKDAMAGE <> 0 then
      if thing.flags4_ex and MF4_EX_NODISKDAMAGE <> 0 then
      begin
        result := true;
        exit;
